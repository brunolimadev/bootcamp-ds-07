...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      dataBalance.income = formatValue(Number(dataBalance.income));
      dataBalance.outcome = formatValue(Number(dataBalance.outcome));
      dataBalance.total = formatValue(Number(dataBalance.total));
